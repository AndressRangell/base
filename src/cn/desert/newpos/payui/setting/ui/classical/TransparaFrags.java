...
/**
 * Creado por zhouqiang el 13/3/2017.
 * @author zhouqiang
 */
    ...
    private void loadViews(){
       metchant = new PopupView(mContext , R.layout.setting_frag_trans_poplist_head){
            ...
            public void setViewsElements(View view) {
                ...
                textView.setText("Información del comerciante");//merchant information
            }
       ...
       trans =  new PopupView(mContext, R.layout.setting_frag_trans_poplist_head) {
            ...
            public void setViewsElements(View view) {
                TextView textView = (TextView) view.findViewById(R.id.setting_trans_poplist_tv);
                textView.setText("Parámetros de transacción");//transaction parameters
            }
       ...
       master =  new PopupView(mContext, R.layout.setting_frag_trans_poplist_head) {
            ...
            public void setViewsElements(View view) {
                TextView textView = (TextView) view.findViewById(R.id.setting_trans_poplist_tv);
                textView.setText("Modificación de la contraseña del supervisor");//Supervisor password modification
            }
       ...
       password =  new PopupView(mContext, R.layout.setting_frag_trans_poplist_head) {
            ...
            public void setViewsElements(View view) {
                TextView textView = (TextView) view.findViewById(R.id.setting_trans_poplist_tv);
                textView.setText("Parámetros de entrada de contraseña de transacción");//whether enter password parameter of transaction
            }
      ...
      carduse =  new PopupView(mContext, R.layout.setting_frag_trans_poplist_head) {
            ...
            public void setViewsElements(View view) {
                TextView textView = (TextView) view.findViewById(R.id.setting_trans_poplist_tv);
                textView.setText("Parámetros de la tarjeta de transacción");//whether use card parameter of transaction
            }
        ...
        scanner =  new PopupView(mContext, R.layout.setting_frag_trans_poplist_head) {
            ...
            public void setViewsElements(View view) {
                TextView textView = (TextView) view.findViewById(R.id.setting_trans_poplist_tv);
                textView.setText("Parámetros del código de escaneo");//scan pay parameters
            }
