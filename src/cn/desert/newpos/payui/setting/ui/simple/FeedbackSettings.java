...
public class FeedbackSettings extends BaseActivity {
    ...
    private void submit(){
        ...
        new Thread(){
            ...
            public void run() {
                message.what = 0 ;
                try {//User feedback and suggestion of Rong Pay
                    int ret = Emailsend.send(FeedbackSettings.this , advice , "Comentarios y sugerencias de los usuarios de Fusion Desktop");
                    message.obj = ret ;
                }catch (Exception e){
