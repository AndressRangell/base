...
public class SSLFactory extends SSLSocketFactory {
	private static final String CLIENT_KEY_MANAGER = "X509"; // Gestor de claves
	private static final String CLIENT_AGREEMENT = "TLSv1.2"; // Acuerdo de uso
	private static final String CLIENT_KEY_KEYSTORE = "BKS"; // "JKS";//Biblioteca secreta，La biblioteca secreta de BouncyCastle se usa aquí
	private static final String CLIENT_KEY_PASSWORD = "123456";// contraseña
